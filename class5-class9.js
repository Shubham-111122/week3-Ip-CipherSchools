...
let setattribute = document
  .querySelector("img")
  .setAttribute("src", "https://www.w3schools.com/html/img_car.jpg");
console.log(setattribute);

let removeattribute = document
  .querySelector("img")
  .removeAttribute("src", "https://www.w3schools.com/html/img_car.jpg");
...
let content = "This is CipherSchools";
